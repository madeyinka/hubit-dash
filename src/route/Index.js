...
import SocialSettings from "../pages/pre-built/settings/SocialSettings"
import Components from "../pages/pre-built/components/Components"
  ...
  return (
    <Suspense fallback={<div />}>
      <Routes>
        ...
        <Route path="/settings/socials/configurations" element={<SocialSettings />} />
...
//         <Route exact path={`${process.env.PUBLIC_URL}/`} component={Analytics}></Route>
